...
def getArguments():
    parser = argparse.ArgumentParser(
        description='Grab input arguments')
...
def xgAPIStartUser(username, name, password, email,
                   group="students", usertype="User",
                   surfquota="3GB PER DAY",
                   ...
                   quarantinedigest="Enable", macbinding="Enable",
